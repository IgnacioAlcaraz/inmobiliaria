...
export type FormaPago =
  ...
  | "Credito aprobado"
  | "Credito en tramite"
  | "Necesita vender primero";
export type SeguimientoPrioridad = "Baja" | "Media" | "Alta";
export type MotivacionOption =
  | "Mudanza"
  | "Inversion"
  | "Divorcio"
  | "Herencia"
...
export const MOTIVACION_OPTIONS: MotivacionOption[] = [
  "Mudanza",
  "Inversion",
  "Divorcio",
  "Herencia",
...
export const PRIORIDAD_OPTIONS: SeguimientoPrioridad[] = [
  "Baja",
  "Media",
  "Alta",
];
export const CONTACTO_CLASIFICACIONES: ContactoClasificacion[] = [
  "A+",
  "A",
  "B",
  "C",
