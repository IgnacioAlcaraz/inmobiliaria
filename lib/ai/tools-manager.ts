  ...
  return [
    tool(
      async ({ anio, vendedorId }) =>
        callRoute("/api/agent/manager/vendedores", {
          managerId,
          vendedorId,
          anio,
        }),
      {
        ...
        schema: z.object({
          vendedorId: z
            ...
            .uuid()
            .optional()
            .describe("UUID del vendedor específico"),
    ...
    tool(
      async ({ anio, vendedorId }) =>
        callRoute("/api/agent/manager/resumen", {
          managerId,
          anio,
          vendedorId,
        }),
      {
        ...
        schema: z.object({
          ...
          vendedorId: z
            ...
            .optional()
            .describe(
              "UUID del vendedor. Si se omite, devuelve todo el equipo",
            ),
        }),
      },
    ),
    ...
    tool(
      async ({ vendedorId, anio, mes, desde, hasta }) =>
        callRoute("/api/agent/manager/cierres", {
          managerId,
          vendedorId,
          anio,
          mes,
    ...
    tool(
      async ({ vendedorId, operacion, conCierre, diasHastaVencimiento }) =>
        callRoute("/api/agent/manager/captaciones", {
          managerId,
          vendedorId,
          operacion,
          conCierre,
        ...
        }),
      {
        ...
        schema: z.object({
          ...
          diasHastaVencimiento: z
            .number()
            .optional()
            .describe("Captaciones que vencen en los próximos N días"),
        }),
      },
    ),
    ...
    tool(
      async ({ vendedorId, anio, mes, desde, hasta }) =>
        callRoute("/api/agent/manager/trackeo", {
          managerId,
          vendedorId,
          anio,
          mes,
    ...
    tool(
      async ({ vendedorId, anio }) =>
        callRoute("/api/agent/manager/objetivos", {
          managerId,
          vendedorId,
          anio,
        }),
    ...
    tool(
      async ({
        ...
        callRoute("/api/agent/manager/contactos", {
          managerId,
          vendedorId,
          estado,
          tipo_cliente,
    ...
    tool(
      async ({ anio, periodo }) =>
        callRoute("/api/agent/manager/okr-global", {
          managerId,
          anio,
          periodo,
        }),
      {
        name: "get_okr_global_manager",
        description:
          "OKR global del equipo: objetivo de honorarios brutos vs honorarios obtenidos, por trimestre (Q1-Q4) o año completo. Usar cuando el encargado pregunta por OKR, objetivo del equipo, cuánto facturó el centro, progreso vs meta o ingresos netos del centro.",
        schema: z.object({
          anio: z.number().optional().describe("Año. Default: año actual"),
          periodo: z
            .enum(["Q1", "Q2", "Q3", "Q4", "year"])
            .optional()
            .describe("Período a consultar. Default: year"),
        }),
      },
    ),
    ...
    tool(
      async ({ anio }) =>
        callRoute("/api/agent/manager/trackeo-reservas-vs-cierres", {
          managerId,
          anio,
        }),
      {
        name: "get_trackeo_reservas_cierres_manager",
        description:
          "Trackeo mensual del equipo: reservas (puntas y valor), captaciones y cierres (puntas y honorarios) mes a mes. Usar cuando el encargado pregunta por reservas vs cierres, evolución mensual de captaciones, pipeline de reservas o trackeo global del equipo.",
        schema: z.object({
          anio: z.number().optional().describe("Año. Default: año actual"),
        }),
      },
    ...
    tool(
      async ({ vendedorId, anio }) =>
        callRoute("/api/agent/manager/tablero-gestion-agente", {
          managerId,
          vendedorId,
          anio,
        }),
      {
        name: "get_tablero_gestion_agente",
        description:
          "Tablero de gestión mensual de un vendedor específico: llamadas, captaciones, reservas, cierres y honorarios mes a mes. Requiere vendedorId. Usar cuando el encargado pide el tablero o desempeño mensual detallado de un agente en particular.",
        schema: z.object({
          vendedorId: z
            .string()
            .uuid()
            .describe("UUID del vendedor. Requerido."),
          anio: z.number().optional().describe("Año. Default: año actual"),
        }),
      },
    ),
    ...
    tool(
      async ({ anio }) =>
        callRoute("/api/agent/manager/captaciones-vs-operaciones-2026", {
          managerId,
          anio,
        }),
      {
        name: "get_captaciones_vs_operaciones_manager",
        description:
          "Captaciones y operaciones cerradas del equipo en el año: lista de captaciones con direcciones, valores y fechas de cierre, más cierres realizados. Usar cuando el encargado pide la cartera de captaciones vs operaciones cerradas, trackeo de cartera o captaciones del año.",
        schema: z.object({
          anio: z.number().optional().describe("Año. Default: año actual"),
        }),
      },
