...
export default async function Page() {
  ...
  const manualRes = await supabase.from('trackeo_manual').select('*').eq('manager_id', user.id)
  ...
  return (
    <div className="p-6">
      <ManagerTrackeoGlobal
        ...
        // pass manual entries to component
        // component will merge/override values when present
        // shape: array of { id, month, section, key, value, text_value }
        // (we pass as prop 'manualEntries')
        // @ts-ignore
